...
class mijiaAPI(object):
    def __init__(self, auth_data: dict):
        ...
        Args:
            auth_data (dict): Dictionary chứa thông tin ủy quyền, phải bao gồm 'userId', 'deviceId', 'ssecurity' và 'serviceToken'.

        Raises:
            Exception: Được ném ra khi dữ liệu ủy quyền không đầy đủ.
        """
    ...
    def available(self) -> bool:
        ...
        Returns:
            bool: Trả về True nếu API khả dụng, ngược lại trả về False.
        """
        if self.expireTime:
    ...
    def get_homes_list(self) -> list:
        ...
        Returns:
            list: Danh sách gia đình, bao gồm thông tin phòng.
        """
    ...
    def get_scenes_list(self, home_id: str) -> list:
        ...
        Thiết lập trong ứng dụng Mijia thông qua "Thêm -> Điều khiển thủ công".

        Args:
            home_id (str): ID gia đình, lấy từ get_homes_list.
